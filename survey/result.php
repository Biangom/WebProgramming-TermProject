<?
   ...
   $total = $row[ans1] + $row[ans2] + $row[ans3] + $row[ans4] + $row[ans5]; 
   ...
   $ans5_percent = $row[ans5]/$total * 100;
   ...
   $ans5_percent = floor($ans5_percent);
?>
...
<body>
    ...
    <table width=250 height=250 border='0' cellspacing='0' cellpadding='0' style = "margin: auto;">
        <tr>
        ...
        <tr>
          ...
          <td></td>
          <td valign=middle><b>홈페이지 만족도</b></td>
          <td></td>
        ...
        <tr>
          ...
          <td></td>
          <td> 매우 만족스럽다. (<b><? echo $ans1_percent ?></b> %)
...
?>
        ...
        <tr>
          <td height=20 bgcolor='#ffffff'></td>
          <td></td>
          <td> 만족스러운 편이다. (<b><? echo $ans2_percent ?></b> %)
...
?>
        ...
        <tr>
          <td height=20 bgcolor='#ffffff'></td>
          <td></td>
          <td> 불만스러운 편이다. (<b><? echo $ans4_percent ?></b> %)
...
?>
        ...
        <tr>
          <td height=20 bgcolor='#ffffff'></td>
          <td></td>
          <td> 매우 불만족스럽다. (<b><? echo $ans5_percent ?></b> %)
            <font color=skyblue><b><? echo $row[ans5] ?></b></font> 명</td>
          <td></td>
          <td bgcolor='#ffffff'></td>
        </tr>
        <tr>
    ...
    <table width=100 border=0 height=3 cellspacing=0 cellpadding=0>
        <tr>
<?
   $rest = 100 - $ans5_percent;
     echo "
          <td width='$ans5_percent%' bgcolor=skyblue></td>
          <td width='$rest%' bgcolor='#dddddd' height=5></td>
               ";
?>
         </tr>
